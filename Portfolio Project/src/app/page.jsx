...
import logoSapphire from '@/images/logos/sap.jpg'
import logoHCL from '@/images/logos/hcl.jpg'
import logoNovolex from '@/images/logos/novolex.jpg'
import logoTCS from '@/images/logos/tcs.jpg'
...
function Resume() {
    let resume = [{
        company: 'Novolex', title: 'IT Analyst', logo: logoNovolex, start: '2024', end: {
            label: 'Present', dateTime: new Date().getFullYear().toString(),
        },
    }, {
        company: 'Sapphire Systems', title: 'IT Support', logo: logoSapphire, start: '2022', end: '2024',
    }, {
        company: 'HCL', title: 'IT Help Desk', logo: logoHCL, start: '2020', end: '2022',
    }, {
        company: 'Tata', title: 'IT Help Desk', logo: logoTCS, start: '2018', end: '2020',
    },]
    ...
    return (<div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
            ...
            <ol className="mt-6 space-y-4">
                {resume.map((role, roleIndex) => (<Role key={roleIndex} role={role}/>))}
            </ol>
            <Button
                href="/Jorge Vargas Resume 2025-05.pdf"
                variant="secondary"
...
function Photos() {
    ...
    return (<div className="mt-16 sm:mt-20">
            <div className="-my-4 flex justify-center gap-5 overflow-hidden py-4 sm:gap-8">
                {[image1, image2, image3, image4, image5].map((image, imageIndex) => (<div
                        key={image.src}
                        className={clsx('relative aspect-9/10 w-44 flex-none overflow-hidden rounded-xl bg-zinc-100 sm:w-72 sm:rounded-2xl dark:bg-zinc-800', rotations[imageIndex % rotations.length],)}
                    >
                        <Image
                            src={image}
                            alt=""
            ...
            <Container className="mt-9">
                <div className="max-w-2xl">
                    <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
                        Aspiring Data Engineer, Python Builder, and Algo Trader.
                    </h1>
                    <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
                        I’m Polo, blending a passion for data pipelines, automation, and algorithmic trading with
                        hands-on Python projects. Whether it’s wrangling messy datasets or testing trading strategies,
                        I’m driven by curiosity and the thrill of solving complex problems.
                    </p>
